...
export default function Index() {
  const patch = <UseMarkDown markdown={PATCH}></UseMarkDown>,
    ...
    patchKeyedChildren = (
      <UseMarkDown markdown={PATCH_KEYED_CHILDREN_SEQUENCE}></UseMarkDown>
    );
    ...
    <article id="rootArticle" className={classMap.article}>
      <main className={classMap.content}>
        ...
        <ul className={classMap.ul}>
          ...
          <li>
            接下来再判断<code>shapeFlags</code>,有三种情况,text,array or no
            children
            <br />
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                i=3,j=0: <code>newIndexToOldIndexMap[i]===0</code> h节点是新节点
                patch(h) 真实节点变为a b [c d e] h f g
              </li>
              <li>
              ...
              <li>
                i=1,j=-1: <code>j &lt; 0</code> d节点需要移动，以c为锚点move
                d节点，真实节点变为a b [d c e] h f g
              </li>
              <li>
                i=0,j=-1: <code>j &lt; 0</code> e节点需要移动，以d为锚点move
                e节点，真实节点变为a b [e d c] h f g
              </li>
            </ul>
          </li>
        </ul>
