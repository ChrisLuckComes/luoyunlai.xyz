...
import { COMMON_JS_EXAMPLE, CJS_APP, WEBPACK_CONFIG_JS, COMMON_JS, ES_MODULE, ES_APP } from './_module';
const { Link } = Anchor;

export default function Index() {
  const commonJsExample = <UseMarkDown markdown={COMMON_JS_EXAMPLE}></UseMarkDown>,
    cjsApp = <UseMarkDown markdown={CJS_APP}></UseMarkDown>,
  ...
  return (
    <article id="root" className={classMap.article}>
      <main className={classMap.content}>
        ...
        <br />
        接下来我们使用webpack@4.x+babel来打包代码，看输出后的js来分析。 webpack.config.js简单配置如下
        {config}
        ...
        <code>module</code>,<code>exports</code>,<code>__webpack_require__</code>(app.js中使用的<code>require</code>
        函数)。
        {cjs}
        <h3 id="require" className={classMap.articleSubTitle}>
          __webpack_require__
        </h3>
        webpack定义该辅助函数实现引入模块的功能，它的入参是<code>moduleId</code>，也就是路径字符串。
        <br />
        <br />
        ...
        <ul className={classMap.ul}>
          ...
          <li>
            ...
            <ul className="pl-60">
              <li>
                1. 创建module对象(包含l,exports等属性)，moduleId作为key添加到<code>installedModules</code>中
              </li>
              <li>
                2. 执行该模块
                <code> modules[moduleId].call( module.exports, module, module.exports, __webpack_require__ )</code>
              </li>
              <li>
        ...
        <code>__webpack_require__.r</code>在exports对象上添加<code>Symbol.toStringTag</code>
        属性，这样对于exports对象使用<code>toString</code>方法会返回<code>[Object Module]</code>。
        <br />
        并且添加了<code>__esModule</code>标识。
        <h3 id="d" className={classMap.articleSubTitle}>
          __webpack_require__.d
        </h3>
        <code>__webpack_require__.d</code>在exports对象上对每个key添加了getter属性。
        ...
        <ul className={classMap.ul}>
          <li>
            1. ESM新增了临时对象<code>_module2__WEBPACK_IMPORTED_MODULE_0__ </code>
            来创建引用，代码实际上访问的还是exports对象
          </li>
          <li>
            2. 对于<code>export default</code>的导出，在exports对象上添加<code>default</code>属性。对于
            <code>export</code>的导出，在exports对象上添加属性<code>getter</code>，返回的是实际变量值。
          </li>
        </ul>
        ...
        <br />
        <br />
        ES Module导出的并不是对象，在编译时，就可以确定模块之间的依赖关系，所以可以认为ES Module是静态加载的，
        <code>tree shaking</code>就是由此而来。
        <Anchor className="anchor" getContainer={() => document.getElementById('content') as HTMLElement}>
          <Link href="#pre" title="前言"></Link>
          <Link href="#webpack" title="借助Webpack分析">
            <Link href="#require" title="__webpack_require__"></Link>
            <Link href="#cjs" title="CommonJS"></Link>
            <Link href="#esm" title="ES Module">
              <Link href="#r" title="__webpack_require__.r"></Link>
              <Link href="#d" title="__webpack_require__.d"></Link>
              <Link href="#esmSummary" title="Es Module的实现"></Link>
            </Link>
          </Link>
