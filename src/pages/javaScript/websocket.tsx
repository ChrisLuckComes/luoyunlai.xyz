...
export default function Index() {
  ...
  return (
    <article id="root" className={classMap.article}>
      ...
      <br />
      新建文件<strong>ws.adapter.ts</strong>，实现<code>WebSocketAdapter</code>
      类。
      ...
      >
        <Link href="#pre" title="WebSocket">
          <Link href="#protocol" title="自定义协议"></Link>
        </Link>
        <Link href="#server" title="服务端实现">
          <Link href="#nest" title="NestJS">
            <Link href="#gateway" title="Gateway"></Link>
            <Link href="#adapter" title="WebSocketAdapter"></Link>
          </Link>
        </Link>
        <Link href="#client" title="客户端实现"></Link>
      </Anchor>
    </article>
  );
}
