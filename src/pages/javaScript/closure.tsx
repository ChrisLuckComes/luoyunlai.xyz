  ...
  return (
    <article id="root" className={classMap.article}>
      <main className={classMap.content}>
        ...
        答案先说一半，闭包是一个对象……
        <br />
        嘿嘿，废话文学皮一下，剩下的一半下文详细分析之后来补上。文中主要涉及<strong>执行上下文</strong>、
        <strong>作用域链</strong>等概念。
        <br />
        ...
        <br />
        看到<strong>Closure</strong>关键字了吧，它就是之前func函数活动对象的引用，相当于
        <code>[[Scopes]][0] = func[activationObject]</code>
        <br />
        为什么会给函数加上<code>[[Scopes]]</code>呢，这里就要讲到js函数的执行了。
        ...
        在一个函数内部定义的函数会把其包含函数的AO加入到自己的作用域链中。因此，匿名函数包含<code>func(str)</code>
        的AO，也就是可以访问到<code>str</code>。<code>func()</code>返回匿名函数后，它的作用域链被初始化为
        <code>func()</code>的AO和全局VO，这样匿名函数就可以访问到<code>func()</code>可以访问的所有变量。
      ...
      <Anchor className="anchor" getContainer={() => document.getElementById('content') as HTMLElement}>
        <Link href="#closure" title="10分钟内搞懂什么是闭包"></Link>
        <Link href="#debug" title="debug分析"></Link>
        <Link href="#function" title="执行上下文">
          <Link href="#scopeChain" title="作用域链"></Link>
        </Link>
        <Link href="#closureDiff" title="闭包的不同之处"></Link>
        <Link href="#use" title="用途"></Link>
