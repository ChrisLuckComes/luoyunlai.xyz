    ...
    <article id="root" className={classMap.article}>
      ...
      <ul>
        ...
        <li>
          ...
          <br />
          <br />
          在构建<code>workInProgress树</code>时会尝试复用<code>current树</code>已有的fiber节点内的属性，在首屏渲染时只有
      ...
      <ul>
        <li>
          ...
          <img src={UPDATE_IMG} />和<code>mount</code>一样，<code>workInProgress树</code>可以复用<code>current树</code>
