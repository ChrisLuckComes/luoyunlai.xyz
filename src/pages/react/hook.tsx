    ...
    <article id="rootActicle" className={classMap.article}>
      <main className={classMap.content}>
        ...
        <ul className={classMap.ul}>
          ...
          <li>
            useCallback：对于<code>useCallback(callback,[depA])</code>，memorizedState保存<code>[callback,depA]</code>
            ，和
        ...
        <code>useReducer</code>的<code>lastRenderedReducer</code>为传入的<code>reducer</code>参数。<code>useState</code>
        的<code>lastRenderedReducer</code>为<code>basicStateReducer</code>
        <br />
        ...
        <code>update</code>时，<code>useReducer</code>和<code>useState</code>调用的是同一个函数
        ...
        调用阶段会执行<code>dispatchAction</code>，此时该函数组件对应的<code>fiber</code>,<code>hook.queue</code>
        已经通过
